...
public:
    ...
    {
        items_.push_back(item); // copying to container
    }

    void push_back(T&& item)
    {
        items_.push_back(std::move(item)); // moving to container
    }
};


TEST_CASE("r-value ref")
{
